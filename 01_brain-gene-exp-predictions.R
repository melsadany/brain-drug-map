...
save_model_tf(model, "data/model-derivatives/gene-exp-prediction-model-r205-082223")
...
pdssave(cbind(mni.hit.whole, predictions), file = "data/model-derivatives/gene-exp-whole-brain-082223.rds")
#################################################################################
